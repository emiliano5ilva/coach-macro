...
const searchUSDA = async (query) => {
  try {
    // Fall back to VITE_API_BASE_URL (what client.js uses) — .env.local only sets the _URL
    // variant, so without this the USDA proxy hits a dead relative /api URL in the app.
