  ...
  return (
    <div style={{ margin: "0 20px 14px" }}>
      ...
      <div style={{ padding: "16px", background: "rgba(34,197,94,0.07)", border: "1.5px solid rgba(34,197,94,0.25)", borderRadius: 14, marginBottom: 12, textAlign: "center" }}>
        <div style={{ fontFamily: "'Barlow Condensed',sans-serif", fontWeight: 900, fontSize: 36, color: "#22c55e", lineHeight: 1 }}>{displayDays}</div>
          ...
          {[{ days: 30, label: "30 Days" }, { days: 90, label: "90 Days" }, { days: 180, label: "180 Days" }].map(({ days, label }) => {
            ...
            return (
              <span key={days} style={{ padding: "3px 10px", borderRadius: 20, fontSize: 10, fontWeight: 700, letterSpacing: ".08em",
                ...
                color: earned ? "#22c55e" : "rgba(245,245,240,.2)",
              ...
              <div key={log.id} style={{ padding: "10px 12px", background: T.s1, border: `1px solid ${T.bd}`, borderRadius: 10, marginBottom: 6, display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
                    ...
                    {log.resolved_at && (
                      <span style={{ fontSize: 9, fontWeight: 700, padding: "1px 6px", borderRadius: 8, background: "rgba(34,197,94,.12)", color: "#22c55e", border: "1px solid rgba(34,197,94,.25)" }}>✓ Resolved</span>
                    )}
                  </div>
                ...
                {!log.resolved_at && (
                  <button onClick={() => onResolve?.(log.id)} style={{ padding: "5px 10px", background: "rgba(34,197,94,.1)", border: "1px solid rgba(34,197,94,.25)", borderRadius: 7, color: "#22c55e", fontSize: 10, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", whiteSpace: "nowrap" }}>
                    Resolve
                  </button>
                )}
              </div>
