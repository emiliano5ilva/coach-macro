    ...
    <div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"}}>
      ...
      <div style={{width:"100%",maxWidth:480,animation:"fadeIn 0.3s ease"}}>
        ...
        {sc===0&&<div style={{animation:"fadeIn 0.3s ease"}}>
          ...
          <p style={{fontSize:15,color:T.mu,lineHeight:1.7,marginBottom:28}}>One system for your nutrition and your training — built around how your body actually works.</p>
        ...
        {sc===1&&<div style={{animation:"fadeIn 0.25s ease"}}>
          <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>1 / 25</div>
          <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:8}}>Sync your health data.</div>
          <p style={{fontSize:13,color:T.mu,lineHeight:1.65,marginBottom:24}}>Hey {d.name} — connect Apple Health to auto-import workouts, steps, and sleep from day one. More accurate from the start.</p>
        ...
        {sc===2&&<div style={{animation:"fadeIn 0.25s ease"}}>
          <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>2 / 25</div>
          <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:8}}>Biological sex?</div>
          <p style={{fontSize:13,color:T.mu,marginBottom:24}}>Used to calculate your metabolic rate accurately.</p>
        ...
        {sc===3&&<div style={{animation:"fadeIn 0.25s ease"}}>
          <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>3 / 25</div>
          <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:8}}>Date of birth.</div>
          <p style={{fontSize:13,color:T.mu,marginBottom:24}}>Age is a key metabolic rate variable. Scroll to select.</p>
        ...
        {sc===4&&<div style={{animation:"fadeIn 0.25s ease"}}>
          <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>4 / 25</div>
          <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:20}}>Your height.</div>
        ...
        {sc===5&&<div style={{animation:"fadeIn 0.25s ease"}}>
          <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>5 / 25</div>
          <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:8}}>Current weight.</div>
          <p style={{fontSize:13,color:T.mu,marginBottom:20}}>Your weight right now — not a goal weight.</p>
          ...
          <div style={{textAlign:"center",marginTop:12,fontSize:17,fontWeight:700,color:T.prot}}>
        ...
        {/* Screens 6-22: choice screens */}
        {sc>=6&&sc<=22&&<ChoiceScreens sc={sc} d={d} upd={upd} auto={auto} next={next}/>}
...
// Screens 6-22 choice screens
function ChoiceScreens({sc,d,upd,auto,next}) {
  const screens = {
    6:{num:"6",q:"Weight history.",sub:`Have you ever weighed ${d.wUnit==="lbs"?Math.round(parseFloat(d.weight||180)*1.15):Math.round(parseFloat(d.weight||80)*1.15)}${d.wUnit} or more? Past weight affects your current metabolism.`,choices:[{v:"yes",l:"Yes, significantly more"},{v:"no",l:"No, this is typical"},{v:"notsure",l:"Not sure"}],key:"wHistory"},
    7:{num:"7",q:"Recent weight trend?",sub:"Think about the past 3–4 weeks.",choices:[{v:"losing",l:"Losing weight",e:"📉"},{v:"gaining",l:"Gaining weight",e:"📈"},{v:"stable",l:"Weight stable",e:"➡️"},{v:"notsure",l:"Not sure",e:"🤔"}],key:"wTrend"},
    9:{num:"9",q:"How active is your job?",sub:"Non-exercise activity (NEAT) can add 300–2,000 kcal/day.",choices:[{v:"desk",l:"Desk / Remote",e:"💻",sub:"Sitting most of the day"},{v:"mix",l:"Mixed",e:"🚶",sub:"Some sitting, some movement"},{v:"feet",l:"On my feet",e:"👟",sub:"Standing and walking most of the day"},{v:"physical",l:"Physical labor",e:"🔨",sub:"Heavy movement all day"}],key:"job"},
    10:{num:"10",q:"Daily steps?",choices:[{v:"u3k",l:"Under 3,000"},{v:"3-6k",l:"3,000–6,000"},{v:"6-10k",l:"6,000–10,000"},{v:"10-15k",l:"10,000–15,000"},{v:"15k+",l:"15,000+"}],key:"steps"},
    11:{num:"11",q:"Exercise sessions per week?",choices:[{v:"n0",l:"0 / week"},{v:"1-3",l:"1–3 / week"},{v:"4-6",l:"4–6 / week"},{v:"7+",l:"7+ / week",sub:"Training every day"}],key:"freq"},
    12:{num:"12",q:"Primary training type?",choices:[{v:"strength",l:"Strength / Lifting",e:"🏋️"},{v:"run",l:"Running / Cardio",e:"🏃"},{v:"hyrox",l:"Hyrox / CrossFit",e:"🔥"},{v:"hybrid",l:"Hybrid — mix of types",e:"⚡"},{v:"sport",l:"Sport specific",e:"🏅"}],key:"trainType"},
    13:{num:"13",q:"Workout intensity?",choices:[{v:"light",l:"Light",e:"💧",sub:"RPE 3–4"},{v:"moderate",l:"Moderate",e:"💦",sub:"RPE 5–6"},{v:"hard",l:"Hard",e:"🔥",sub:"RPE 7–8"},{v:"extreme",l:"Extreme",e:"⚡",sub:"RPE 9–10, all-out every session"}],key:"intensity"},
    14:{num:"14",q:"Activity outside workouts?",choices:[{v:"sedentary",l:"Mostly sedentary",e:"🛋️",sub:"Gym → couch"},{v:"moderate",l:"Moderately active",e:"🚶",sub:"Regular errands, weekend activities"},{v:"very",l:"Very active",e:"🏃",sub:"High energy lifestyle outside the gym"}],key:"activity"},
    15:{num:"15",q:"Average sleep hours?",sub:"Sleep deprivation reduces metabolic rate.",choices:[{v:"u5",l:"Under 5 hours"},{v:"5-6",l:"5–6 hours"},{v:"6-7",l:"6–7 hours"},{v:"7-8",l:"7–8 hours",sub:"Optimal"},{v:"8+",l:"8+ hours"}],key:"sleep"},
    16:{num:"16",q:"Sleep quality?",choices:[{v:"poor",l:"Poor",e:"😴"},{v:"fair",l:"Fair",e:"😐"},{v:"good",l:"Good",e:"🙂"},{v:"excellent",l:"Excellent",e:"⚡"}],key:"sleepQ"},
    17:{num:"17",q:"Dieting history?",sub:"Prolonged restriction causes metabolic adaptation — we adjust for it.",choices:[{v:"not",l:"Not dieting"},{v:"u3",l:"Deficit under 3 months"},{v:"3plus",l:"3+ months in a deficit",sub:"Significant adaptation likely"},{v:"offon",l:"On-and-off for years"}],key:"metHistory"},
    18:{num:"18",q:"Protein intake?",sub:"High protein raises TDEE via the thermic effect of food.",choices:[{v:"none",l:"I don't track it"},{v:"low",l:"Very little"},{v:"moderate",l:"Some, inconsistently"},{v:"high",l:"High — I hit a daily target",sub:"0.7–1g+ per lb bodyweight"}],key:"protein"},
    20:{num:"20",q:"Menstrual cycle status.",sub:"Calorie needs shift 150–350 kcal across your cycle.",choices:[{v:"regular",l:"Regular cycle"},{v:"irregular",l:"Irregular cycle"},{v:"peri",l:"Perimenopausal / Menopausal"},{v:"hbc",l:"Using hormonal birth control"},{v:"prefer",l:"Prefer not to say"}],key:"cycle"},
    21:{num:"21",q:"Weightlifting experience?",choices:[{v:"none",l:"None",e:"🌱"},{v:"beginner",l:"Beginner",e:"💪",sub:"< 1 year"},{v:"intermediate",l:"Intermediate",e:"🔥",sub:"1–4 years"},{v:"advanced",l:"Advanced",e:"⚡",sub:"4+ years"}],key:"liftExp"},
    22:{num:"22",q:"Cardio experience?",choices:[{v:"none",l:"None",e:"🌱"},{v:"beginner",l:"Beginner",e:"🚶",sub:"Occasional jogging"},{v:"intermediate",l:"Intermediate",e:"🏃",sub:"Can run 5K+"},{v:"advanced",l:"Advanced",e:"🏅",sub:"Half marathon+ fitness"}],key:"cardioExp"},
  };

  // Body fat screen
  if(sc===8) return (
    <div style={{animation:"fadeIn 0.25s ease"}}>
      <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>8 / 25</div>
      <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:8}}>Estimate your body fat.</div>
      <p style={{fontSize:13,color:T.mu,marginBottom:20}}>Unlocks a more accurate equation. Closest match is fine.</p>
  ...
  if(sc===19) {
    ...
    return (
      <div style={{animation:"fadeIn 0.25s ease"}}>
        <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>19 / 25</div>
        <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:8}}>Health conditions?</div>
        <p style={{fontSize:13,color:T.mu,marginBottom:20}}>We adjust your equation accordingly. Select all that apply.</p>
        {[{v:"thyroid",l:"Thyroid condition",sub:"Up to −25% BMR"},{v:"pcos",l:"PCOS"},{v:"diabetes",l:"Type 1 or 2 Diabetes"},{v:"meds",l:"Weight-affecting medication"},{v:"none",l:"None of the above"}].map(o=>(
  ...
  return (
    <div style={{animation:"fadeIn 0.25s ease"}}>
      <div style={{fontSize:11,color:T.prot,fontWeight:700,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>{screen.num} / 25</div>
      <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:36,fontWeight:900,marginBottom:screen.sub?8:20}}>{screen.q}</div>
      {screen.sub&&<p style={{fontSize:13,color:T.mu,lineHeight:1.65,marginBottom:20}}>{screen.sub}</p>}
