    ...
    <div style={{
      ...
      <div style={{ background: "var(--navy-card)", padding: "14px 16px 16px" }}>
        ...
        <div style={{ fontSize: 13, color: "rgba(245,245,240,.7)", lineHeight: 1.6, marginBottom: 14 }}>
          You've been eating <strong style={{ color: "#fff" }}>{pd.currentCalories} calories</strong> for <strong style={{ color: "#fff" }}>{pd.weeksOnSameCalories} weeks</strong> and your weight has barely moved — despite hitting your targets <strong style={{ color: T.green }}>{pd.adherence}%</strong> of the time.
          <br /><br />
    ...
    <div style={{
      ...
      <div style={{ fontSize: 12, color: "rgba(245,245,240,.65)", lineHeight: 1.6, marginBottom: 14 }}>
        ...
        <div style={{ margin: "10px 0", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: "var(--condensed)", fontWeight: 900, fontSize: 26, color: T.fat }}>{phases.phase1?.calories}</span>
          <span style={{ fontSize: 11, color: "rgba(245,245,240,.4)" }}>cal/day this week</span>
        </div>
        <span style={{ color: T.fat, fontWeight: 700 }}>This is intentional</span> — eating more to lose more. Trust the process.
      </div>
      <div style={{ display: "flex", gap: 8 }}>
          ...
          <div style={{ background: "rgba(255,255,255,.03)", borderRadius: 10, padding: "10px 12px" }}>
            ...
            {progress.phase === 1 && (
              <div style={{ fontSize: 11, color: "rgba(245,245,240,.65)", lineHeight: 1.6 }}>
                ...
                <strong style={{ color: T.fat }}>Trust the process.</strong>
              </div>
            )}
            {progress.phase === 2 && (
              <div style={{ fontSize: 11, color: "rgba(245,245,240,.65)", lineHeight: 1.6 }}>
            ...
            {progress.phase === 3 && !progress.isComplete && (
              <div style={{ fontSize: 11, color: "rgba(245,245,240,.65)", lineHeight: 1.6 }}>
                ...
                <strong style={{ color: T.green }}>Monitor the scale — you should see movement now.</strong>
              </div>
            )}
            {progress.isComplete && (
              <div>
                <div style={{ fontFamily: "var(--condensed)", fontWeight: 900, fontSize: 16, color: T.green, marginBottom: 6 }}>
                ...
                <button
                  onClick={onComplete}
                  style={{
                    padding: "10px 18px", background: T.green, border: "none", borderRadius: 10,
